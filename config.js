...
const SUDO = process.env.SUDO || '48459089004';
const AUTO_STATUS_VIEW = process.env.AUTO_STATUS_VIEW || "true";
const ALWAYS_ONLINE = process.env.ALWAYS_ONLINE || "true";
const BOT_INFO = process.env.BOT_INFO || "Fadi-MD;Mr_Fadi;https://i.imgur.com/r3GZeiX.jpeg";
const URL = process.env.URL || "https://www.instagram.com/imspxxky";
const AUDIO_DATA = process.env.AUDIO_DATA || "Fadi-MD;Mr_Fadi;https://i.imgur.com/fVCRCYG.jpeg";
const STICKER_DATA = process.env.STICKER_DATA || "Fadi MD; Mr_Fadi";
